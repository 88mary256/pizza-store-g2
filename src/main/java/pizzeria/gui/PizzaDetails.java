...
public class PizzaDetails extends JDialog {
    ...
    final JPanel extraIngredientsPanel = new JPanel();
    final JPanel toRemoveIngredientsPanel = new JPanel();
    final JComboBox toAddCombobox = new JComboBox();
    final JComboBox toRemoveCombobox = new JComboBox();
